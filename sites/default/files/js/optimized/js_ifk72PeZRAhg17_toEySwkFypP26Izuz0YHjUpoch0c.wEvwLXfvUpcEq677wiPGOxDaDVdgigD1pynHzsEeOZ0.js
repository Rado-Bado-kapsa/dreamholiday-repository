/* Source and licensing information for the line(s) below can be found at https://www.dreamholiday.space/modules/token/js/token.js. */
(function(t,e,n){'use strict';e.behaviors.tokenTree={attach:function(e,n){t('table.token-tree',e).once('token-tree').each(function(){t(this).treetable({expandable:!0})})}};e.behaviors.tokenInsert={attach:function(i,o){t('textarea, input[type="text"]',i).focus(function(){n.tokenFocusedField=this});t('.token-click-insert .token-key',i).once('token-click-insert').each(function(){var i=t('<a href="javascript:void(0);" title="'+e.t('Insert this token into your form')+'">'+t(this).html()+'</a>').click(function(){var i=this.text;if(n.tokenFocusedField&&(n.tokenFocusedField.tokenDialogFocus||n.tokenFocusedField.tokenHasFocus)){s(n.tokenFocusedField,i)}
...
else{alert(e.t('First click a text field to insert your tokens into.'))};return!1});t(this).html(i)});function s(e,t){var s=e.scrollTop;if(document.selection){e.focus();var o=document.selection.createRange();o.text=t}
...
/* Source and licensing information for the above line(s) can be found at https://www.dreamholiday.space/modules/token/js/token.js. */