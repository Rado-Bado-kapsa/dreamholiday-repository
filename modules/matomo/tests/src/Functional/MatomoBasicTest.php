...
class MatomoBasicTest extends BrowserTestBase {
  ...
  protected function setUp(): void {
    ...
    $this->sessionStorageOptions = $this->container->getParameter('session.storage.options');
  ...
  public function testMatomoConfiguration() {
    ...
    $this->assertSession()->responseContains('A valid Matomo site ID is an integer only.');
  ...
  public function testMatomoTrackingCode() {
    ...
    */
    ...
    // @todo Workaround to run tests successfully. This feature cannot be tested
    // reliable.
